...
//template<typename T> inline T* MakePointerGEN( DWORD base, DWORD offset ) { return reinterpret_cast<T*>( base + offset ); }
template<typename T> inline T* MakePointerGEN2( DWORD base, DWORD offset ) { return reinterpret_cast<T*>( base + offset ); }
...
struct GenDT_BaseCombatCharacter : public GenDT_BaseFlex
{
	...
	{
		inline float* flNextAttack() { return MakePointerGEN< float >( this, 0xbc8 ); }
	};
	inline CBCCLocalPlayerExclusive* bcc_localdata() { return MakePointerGEN< CBCCLocalPlayerExclusive >( this, 0x0 ); }
	inline EHANDLE* hActiveWeapon() { return MakePointerGEN< EHANDLE >( this, 0xd10 ); }
	inline EHANDLE* hMyWeapons() { return MakePointerGEN< EHANDLE >( this, 0xc50 ); } // Array size = 48
	inline bool* bGlowEnabled() { return MakePointerGEN< bool >( this, 0xd14 ); }
};
...
{
	inline Vector* lookAtSpot() { return MakePointerGEN< Vector >( this, 0xd40 ); }
	inline int* attitude() { return MakePointerGEN< int >( this, 0xd4c ); }
};
...
{
	inline bool* bReadyToBackstab() { return MakePointerGEN< bool >( this, 0xab0 ); }
...
{
	inline Vector* vInitialVelocity() { return MakePointerGEN< Vector >( this, 0x820 ); }
};
struct GenDT_BaseObject : public GenDT_BaseCombatCharacter
{
	inline int* iHealth() { return MakePointerGEN< int >( this, 0xe84 ); }
	inline int* iMaxHealth() { return MakePointerGEN< int >( this, 0xe88 ); }
	inline bool* bHasSapper() { return MakePointerGEN< bool >( this, 0xe7c ); }
	inline int* iObjectType() { return MakePointerGEN< int >( this, 0xe80 ); }
	inline bool* bBuilding() { return MakePointerGEN< bool >( this, 0xe8d ); }
	inline bool* bPlacing() { return MakePointerGEN< bool >( this, 0xe8f ); }
	inline bool* bCarried() { return MakePointerGEN< bool >( this, 0xe92 ); }
	inline bool* bCarryDeploy() { return MakePointerGEN< bool >( this, 0xe93 ); }
	inline bool* bMiniBuilding() { return MakePointerGEN< bool >( this, 0xe95 ); }
	inline float* flPercentageConstructed() { return MakePointerGEN< float >( this, 0xe98 ); }
	inline int* fObjectFlags() { return MakePointerGEN< int >( this, 0xe60 ); }
	inline EHANDLE* hBuiltOnEntity() { return MakePointerGEN< EHANDLE >( this, 0xe9c ); }
	inline bool* bDisabled() { return MakePointerGEN< bool >( this, 0xe90 ); }
	inline EHANDLE* hBuilder() { return MakePointerGEN< EHANDLE >( this, 0xe70 ); }
	inline Vector* vecBuildMaxs() { return MakePointerGEN< Vector >( this, 0xea4 ); }
	inline Vector* vecBuildMins() { return MakePointerGEN< Vector >( this, 0xeb0 ); }
	inline int* iDesiredBuildRotations() { return MakePointerGEN< int >( this, 0xebc ); }
	inline bool* bServerOverridePlacement() { return MakePointerGEN< bool >( this, 0xec8 ); }
	inline int* iUpgradeLevel() { return MakePointerGEN< int >( this, 0xe4c ); }
	inline int* iUpgradeMetal() { return MakePointerGEN< int >( this, 0xe54 ); }
	inline int* iHighestUpgradeLevel() { return MakePointerGEN< int >( this, 0xe58 ); }
	inline int* iObjectMode() { return MakePointerGEN< int >( this, 0xea0 ); }
	inline bool* bDisposableBuilding() { return MakePointerGEN< bool >( this, 0xe96 ); }
};
...
struct GenDT_BasePlayer : public GenDT_BaseCombatCharacter
{
	struct CLocalPlayerExclusive
	{
		...
		inline CLocal* Local() { return MakePointerGEN< CLocal >( this, 0xd6c ); }
		...
		inline int* iAmmo() { return MakePointerGEN< int >( this, 0xbd0 ); } // Array size = 32
		inline int* fOnTarget() { return MakePointerGEN< int >( this, 0xf8c ); }
		inline int* nTickBase() { return MakePointerGEN< int >( this, 0x108c ); }
		inline int* nNextThinkTick() { return MakePointerGEN< int >( this, 0x84 ); }
		inline EHANDLE* hLastWeapon() { return MakePointerGEN< EHANDLE >( this, 0x10a0 ); }
		...
		inline EHANDLE* hConstraintEntity() { return MakePointerGEN< EHANDLE >( this, 0xfc4 ); }
		inline Vector* vecConstraintCenter() { return MakePointerGEN< Vector >( this, 0xfc8 ); }
		inline float* flConstraintRadius() { return MakePointerGEN< float >( this, 0xfd4 ); }
		inline float* flConstraintWidth() { return MakePointerGEN< float >( this, 0xfd8 ); }
		inline float* flConstraintSpeedFactor() { return MakePointerGEN< float >( this, 0xfdc ); }
		inline float* flDeathTime() { return MakePointerGEN< float >( this, 0x1004 ); }
		inline int* nWaterLevel() { return MakePointerGEN< int >( this, 0x160 ); }
		inline float* flLaggedMovementValue() { return MakePointerGEN< float >( this, 0x11dc ); }
	};
	struct CAttributeList
	{
	}; // Fail count = 1
	...
	inline CAttributeList* AttributeList() { return MakePointerGEN< CAttributeList >( this, 0xf48 ); }
	inline CPlayerState* pl() { return MakePointerGEN< CPlayerState >( this, 0xf64 ); }
	inline int* iFOV() { return MakePointerGEN< int >( this, 0xf78 ); }
	inline int* iFOVStart() { return MakePointerGEN< int >( this, 0xf7c ); }
	inline float* flFOVTime() { return MakePointerGEN< float >( this, 0xf80 ); }
	inline int* iDefaultFOV() { return MakePointerGEN< int >( this, 0xf84 ); }
	inline EHANDLE* hZoomOwner() { return MakePointerGEN< EHANDLE >( this, 0xf88 ); }
	inline EHANDLE* hVehicle() { return MakePointerGEN< EHANDLE >( this, 0x1010 ); }
	inline EHANDLE* hUseEntity() { return MakePointerGEN< EHANDLE >( this, 0x1018 ); }
	inline int* iHealth() { return MakePointerGEN< int >( this, 0x90 ); }
	inline int* lifeState() { return MakePointerGEN< int >( this, 0x8f ); }
	inline int* iBonusProgress() { return MakePointerGEN< int >( this, 0x1020 ); }
	inline int* iBonusChallenge() { return MakePointerGEN< int >( this, 0x1024 ); }
	inline float* flMaxspeed() { return MakePointerGEN< float >( this, 0x101c ); }
	inline int* fFlags() { return MakePointerGEN< int >( this, 0x2fc ); }
	inline int* iObserverMode() { return MakePointerGEN< int >( this, 0xfe0 ); }
	inline EHANDLE* hObserverTarget() { return MakePointerGEN< EHANDLE >( this, 0xfe4 ); }
	inline EHANDLE* hViewModel0() { return MakePointerGEN< EHANDLE >( this, 0x10b8 ); }
	inline EHANDLE* hViewModel() { return MakePointerGEN< EHANDLE >( this, 0x0 ); } // Array size = 2
	inline char** szLastPlaceName() { return MakePointerGEN< char* >( this, 0x11fc ); }
...
struct GenDT_TFPlayer : public GenDT_BasePlayer
{
	...
	struct CTFPlayerShared
	{
		struct CTFPlayerSharedLocal
		{
			...
			inline float* flStealthNoAttackExpire() { return MakePointerGEN< float >( this, 0x2c0 ); }
			inline float* flStealthNextChangeTime() { return MakePointerGEN< float >( this, 0x2c4 ); }
			...
			inline bool* bPlayerDominated() { return MakePointerGEN< bool >( this, 0x2cc ); } // Array size = 34
			inline bool* bPlayerDominatingMe() { return MakePointerGEN< bool >( this, 0x2ee ); } // Array size = 34
		...
		inline bool* bJumping() { return MakePointerGEN< bool >( this, 0x2b0 ); }
		inline int* nNumHealers() { return MakePointerGEN< int >( this, 0x208 ); }
		inline int* iCritMult() { return MakePointerGEN< int >( this, 0x2c8 ); }
		inline int* iAirDash() { return MakePointerGEN< int >( this, 0x2b4 ); }
		inline int* nAirDucked() { return MakePointerGEN< int >( this, 0x2b8 ); }
		inline float* flDuckTimer() { return MakePointerGEN< float >( this, 0x2bc ); }
		...
		inline float* flMovementStunTime() { return MakePointerGEN< float >( this, 0x310 ); }
		inline int* iMovementStunAmount() { return MakePointerGEN< int >( this, 0x314 ); }
		inline int* iMovementStunParity() { return MakePointerGEN< int >( this, 0x318 ); }
		inline EHANDLE* hStunner() { return MakePointerGEN< EHANDLE >( this, 0x31c ); }
		inline int* iStunFlags() { return MakePointerGEN< int >( this, 0x320 ); }
		inline int* nArenaNumChanges() { return MakePointerGEN< int >( this, 0x330 ); }
		inline bool* bArenaFirstBloodBoost() { return MakePointerGEN< bool >( this, 0x3a7 ); }
		inline int* iWeaponKnockbackID() { return MakePointerGEN< int >( this, 0x334 ); }
		inline bool* bLoadoutUnavailable() { return MakePointerGEN< bool >( this, 0x338 ); }
		inline int* iItemFindBonus() { return MakePointerGEN< int >( this, 0x33c ); }
		inline bool* bShieldEquipped() { return MakePointerGEN< bool >( this, 0x340 ); }
		inline int* iNextMeleeCrit() { return MakePointerGEN< int >( this, 0x350 ); }
		inline int* iDecapitations() { return MakePointerGEN< int >( this, 0x344 ); }
		inline int* iRevengeCrits() { return MakePointerGEN< int >( this, 0x34c ); }
		inline int* iDisguiseBody() { return MakePointerGEN< int >( this, 0x35c ); }
		inline EHANDLE* hCarriedObject() { return MakePointerGEN< EHANDLE >( this, 0x324 ); }
		inline bool* bCarryingObject() { return MakePointerGEN< bool >( this, 0x328 ); }
		inline float* flNextNoiseMakerTime() { return MakePointerGEN< float >( this, 0x360 ); }
		inline int* iKillCountSinceLastDeploy() { return MakePointerGEN< int >( this, 0x364 ); }
		inline float* flFirstPrimaryAttack() { return MakePointerGEN< float >( this, 0x368 ); }
	...
	struct CTFLocalPlayerExclusive
	{
		...
		inline QAngle* angEyeAngles0() { return MakePointerGEN< QAngle >( this, 0x1978 ); }
		inline bool* bIsCoaching() { return MakePointerGEN< bool >( this, 0x19d8 ); }
		inline EHANDLE* hCoach() { return MakePointerGEN< EHANDLE >( this, 0x19b8 ); }
		inline EHANDLE* hStudent() { return MakePointerGEN< EHANDLE >( this, 0x19bc ); }
	}; // Fail count = 2
	struct CTFNonLocalPlayerExclusive
	{
		...
		inline Vector* vecOrigin2() { return MakePointerGEN< Vector >( this, 0x2ec ); }
		inline QAngle* angEyeAngles0() { return MakePointerGEN< QAngle >( this, 0x1978 ); }
		inline QAngle* angEyeAngles1() { return MakePointerGEN< QAngle >( this, 0x197c ); }
	};
	...
	inline bool* bSaveMeParity() { return MakePointerGEN< bool >( this, 0x19d6 ); }
	inline bool* bIsABot() { return MakePointerGEN< bool >( this, 0x19d5 ); }
	inline int* nWaterLevel() { return MakePointerGEN< int >( this, 0x160 ); }
	inline EHANDLE* hRagdoll() { return MakePointerGEN< EHANDLE >( this, 0x13e4 ); }
	inline CTFPlayerClassShared* PlayerClass() { return MakePointerGEN< CTFPlayerClassShared >( this, 0x1454 ); }
	inline CTFPlayerShared* Shared() { return MakePointerGEN< CTFPlayerShared >( this, 0x15cc ); }
	inline EHANDLE* hItem() { return MakePointerGEN< EHANDLE >( this, 0x19b0 ); }
	...
	inline bool* bIsReadyToHighFive() { return MakePointerGEN< bool >( this, 0x19d9 ); }
	inline EHANDLE* hHighFivePartner() { return MakePointerGEN< EHANDLE >( this, 0x19dc ); }
	inline float* flTauntYaw() { return MakePointerGEN< float >( this, 0x19e0 ); }
	inline bool* bInPowerPlay() { return MakePointerGEN< bool >( this, 0x19cd ); }
	inline int* iSpawnCounter() { return MakePointerGEN< int >( this, 0x19d0 ); }
	inline bool* bArenaSpectator() { return MakePointerGEN< bool >( this, 0x19d4 ); }
	inline CAttributeManager* AttributeManager() { return MakePointerGEN< CAttributeManager >( this, 0x13a0 ); }
	inline bool* bGlowEnabled() { return MakePointerGEN< bool >( this, 0xd14 ); }
};
struct GenDT_TFRagdoll
{
	inline Vector* vecRagdollOrigin() { return MakePointerGEN< Vector >( this, 0xbd4 ); }
	inline int* iPlayerIndex() { return MakePointerGEN< int >( this, 0xbe0 ); }
	inline Vector* vecForce() { return MakePointerGEN< Vector >( this, 0x50c ); }
	inline Vector* vecRagdollVelocity() { return MakePointerGEN< Vector >( this, 0xbc8 ); }
	inline int* nForceBone() { return MakePointerGEN< int >( this, 0x518 ); }
	inline bool* bGib() { return MakePointerGEN< bool >( this, 0xbe9 ); }
	inline bool* bBurning() { return MakePointerGEN< bool >( this, 0xbea ); }
	inline bool* bElectrocuted() { return MakePointerGEN< bool >( this, 0xbeb ); }
	inline bool* bFeignDeath() { return MakePointerGEN< bool >( this, 0xbee ); }
	inline bool* bWasDisguised() { return MakePointerGEN< bool >( this, 0xbef ); }
	inline bool* bOnGround() { return MakePointerGEN< bool >( this, 0xc1a ); }
	inline bool* bCloaked() { return MakePointerGEN< bool >( this, 0xbf0 ); }
	inline bool* bBecomeAsh() { return MakePointerGEN< bool >( this, 0xbf1 ); }
	inline int* iDamageCustom() { return MakePointerGEN< int >( this, 0xbf4 ); }
	inline int* iTeam() { return MakePointerGEN< int >( this, 0xc0c ); }
	inline int* iClass() { return MakePointerGEN< int >( this, 0xc10 ); }
	inline EHANDLE* hRagWearables() { return MakePointerGEN< EHANDLE >( this, 0x0 ); } // Array size = 9
	inline bool* bGoldRagdoll() { return MakePointerGEN< bool >( this, 0xbf8 ); }
	inline bool* bIceRagdoll() { return MakePointerGEN< bool >( this, 0xbf9 ); }
};
...
{
	inline int* iState() { return MakePointerGEN< int >( this, 0xed0 ); }
	inline float* flRechargeTime() { return MakePointerGEN< float >( this, 0xed8 ); }
	inline float* flCurrentRechargeDuration() { return MakePointerGEN< float >( this, 0xedc ); }
	inline int* iTimesUsed() { return MakePointerGEN< int >( this, 0xee0 ); }
	inline float* flYawToExit() { return MakePointerGEN< float >( this, 0xee4 ); }
	inline bool* bMatchBuilding() { return MakePointerGEN< bool >( this, 0xee8 ); }
};
struct GenDT_ObjectSentrygun : public GenDT_BaseObject
{
	struct CSentrygunLocalData
	{
		inline int* iKills() { return MakePointerGEN< int >( this, 0xee0 ); }
		inline int* iAssists() { return MakePointerGEN< int >( this, 0xee4 ); }
	};
	inline int* iAmmoShells() { return MakePointerGEN< int >( this, 0xed4 ); }
	inline int* iAmmoRockets() { return MakePointerGEN< int >( this, 0xedc ); }
	inline int* iState() { return MakePointerGEN< int >( this, 0xed0 ); }
	inline bool* bPlayerControlled() { return MakePointerGEN< bool >( this, 0xef4 ); }
	inline bool* bShielded() { return MakePointerGEN< bool >( this, 0xef6 ); }
	inline EHANDLE* hEnemy() { return MakePointerGEN< EHANDLE >( this, 0xf30 ); }
	inline EHANDLE* hAutoAimTarget() { return MakePointerGEN< EHANDLE >( this, 0xf34 ); }
...
{
	inline int* iAmmoMetal() { return MakePointerGEN< int >( this, 0xee8 ); }
}; // Fail count = 2
...
{
	inline int* lifeState() { return MakePointerGEN< int >( this, 0x8f ); }
	inline bool* bPerformAvoidance() { return MakePointerGEN< bool >( this, 0xd34 ); }
	inline bool* bIsMoving() { return MakePointerGEN< bool >( this, 0xd35 ); }
	inline bool* bFadeCorpse() { return MakePointerGEN< bool >( this, 0xd36 ); }
	inline int* iDeathPose() { return MakePointerGEN< int >( this, 0xd24 ); }
	inline int* iDeathFrame() { return MakePointerGEN< int >( this, 0xd28 ); }
	inline int* iSpeedModRadius() { return MakePointerGEN< int >( this, 0xd2c ); }
	inline int* iSpeedModSpeed() { return MakePointerGEN< int >( this, 0xd30 ); }
	inline bool* bSpeedModActive() { return MakePointerGEN< bool >( this, 0xd37 ); }
	inline bool* bImportanRagdoll() { return MakePointerGEN< bool >( this, 0xd38 ); }
	inline float* flTimePingEffect() { return MakePointerGEN< float >( this, 0xd20 ); }
};
struct GenDT_Beam
{
